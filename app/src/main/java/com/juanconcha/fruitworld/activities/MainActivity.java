package com.juanconcha.fruitworld.activities;
...
import com.juanconcha.fruitworld.adapters.FruitAdapter;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.add_fruit:
                this.addFruit(new Fruit("Added nº" + (++counter), R.mipmap.ic_fruit, "Unknown"));
                return true;
            case R.id.list_view:
    ...
    private List<Fruit> getAllFruits() {
        List<Fruit> list = new ArrayList<Fruit>() {{
            ...
            add(new Fruit("Raspberry",R.mipmap.ic_raspeberry, "Barcelona"));
        }};
        return list;
    }
